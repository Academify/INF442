 ...
 * junto com classes concretas constru�das com heran�a.
...
public class Teste extends JFrame {
	...
	private FigListInterface constroiDados() {
		...
		figs.addFig(new LineDrawable(10, 100, 120, 500, Color.RED));
		...
		c.addFig(new LineDrawable(50, 80, 80, 50, Color.GREEN));
		figs.addFig(c);
		return figs;
	}
